...
/**
 * Preprost streĹľnik, ki sprejema TCP povezave in odgovarja
 * klientu tako, da ponavlja vse, kar mu klient poĹˇlje.
 * ÄŚe klient poĹˇlje {@code "bye"}, ga streĹľnik odklopi.
 * 
 * @author Andrej Bauer
 *
 */
